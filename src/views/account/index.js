...
const columns = [
	{field: 'id', headerName: 'ID', width: 70, type: 'lock'},
	{field: 'avatar', headerName: 'Avatar', width: 80, type: 'file', renderCell: parseAvatar},
	...
	{field: 'about', headerName: 'About', type: 'freeText', width: 200},
...
const URL = `${process.env.REACT_APP_BASE_URL}/managment/users-profile`;

export default function Users() {
	return <MFCD columns={columns} url={URL} title="Users Profiles" create={false} destroy={false}/>;
}
